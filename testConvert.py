...
#     check_flag=0
#     clipped = False
#     with open("/home/chetan/Downloads/ex/drone-"+str(j-diff)+".csv", "r") as csv_file:
...
# 			try:
# 				file=open("/home/chetan/Downloads/ex/bins/drone-"+str(j-diff)+".csv","r")
# 				line_no=0
# 				Content = file.read() 
...
# 				with open("/home/chetan/Downloads/ex/bins/drone-"+str(j-diff)+".csv", "r") as csv_file:
# 					i=0
# 					csv_reader = csv.reader(csv_file, delimiter='\t')
# 					wavepoint_file=open(os.path.normpath("/home/chetan/Downloads/ex/bins/drone_"+str(animeid)+"_"+str(j)+".baf"),"wb")
# 					frame = anim_ds()
...
# 							generate_kml_3d_polyline(dronepathlist, os.path.normpath("/home/chetan/Downloads/ex/paths/drone-"+str(j-diff)+"-path.kml"))
...
# 			j=j+1
# 	generate_all_drones_kml_3d_polyline(all_paths, os.path.normpath("/home/chetan/Downloads/ex/paths/complete_paths.kml"))
...
#     with open(os.path.normpath('/home/chetan/Downloads/ex/paths/takeoff_points.kml'), 'w') as kml_file:
